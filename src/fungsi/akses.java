...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            toko_surat_pemesanan=false,toko_pengajuan_barang=false,toko_penerimaan_barang=false,toko_pengadaan_barang=false,alih_rawat=false;
       ...
       try {                
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.alih_rawat=rs2.getBoolean("alih_rawat");
    ...
    public static boolean getalih_rawat(){return akses.alih_rawat;}
