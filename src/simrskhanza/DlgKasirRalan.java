...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnDialihRawat = new javax.swing.JMenuItem();
        ...
        MnAlihRawat = new javax.swing.JMenuItem();
        ...
        MnCetakSuratSehat1.setText("Surat Keterangan Sehat Jasmani");
        ...
        MnCetakSuratSehat3.setBackground(new java.awt.Color(255, 255, 254));
        ...
        MnCetakSuratSehat3.setText("Surat Keterangan Sehat Rohani");
        MnCetakSuratSehat3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakSuratSehat3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakSuratSehat3.setName("MnCetakSuratSehat3"); // NOI18N
        MnCetakSuratSehat3.setPreferredSize(new java.awt.Dimension(320, 26));
        MnCetakSuratSehat3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratSehat3ActionPerformed(evt);
            }
        });
        jMenu4.add(MnCetakSuratSehat3);
        ...
        MnDialihRawat.setBackground(new java.awt.Color(255, 255, 254));
        MnDialihRawat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnDialihRawat.setForeground(new java.awt.Color(50, 50, 50));
        MnDialihRawat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnDialihRawat.setText("Alih Rawat");
        MnDialihRawat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnDialihRawat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnDialihRawat.setName("MnDialihRawat"); // NOI18N
        MnDialihRawat.setPreferredSize(new java.awt.Dimension(150, 26));
        MnDialihRawat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnDialihRawatActionPerformed(evt);
            }
        });
        MnRujukan.add(MnDialihRawat);
        ...
        MnAlihRawat.setBackground(new java.awt.Color(255, 255, 254));
        MnAlihRawat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAlihRawat.setForeground(new java.awt.Color(50, 50, 50));
        MnAlihRawat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnAlihRawat.setText("AlihRawat");
        MnAlihRawat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnAlihRawat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnAlihRawat.setName("MnAlihRawat"); // NOI18N
        MnAlihRawat.setPreferredSize(new java.awt.Dimension(180, 26));
        MnAlihRawat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnAlihRawatActionPerformed(evt);
            }
        });
        MnStatus.add(MnAlihRawat);
        ...
        MnTeridentifikasiTB1.setForeground(new java.awt.Color(50, 50, 50));
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-11-2020" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-11-2020" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-11-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-11-2020" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
 ...
 private void MnAlihrawatActionPerformed(java.awt.event.ActionEvent evt) {                                        
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgAlihRawat dlgarw=new DlgAlihRawat(null,false);
            dlgarw.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            dlgarw.setLocationRelativeTo(internalFrame1);
            dlgarw.emptTeks();
            dlgarw.isCek();
            dlgarw.setNoRm(TNoRw.getText(),DTPCari1.getDate(),DTPCari2.getDate());
            dlgarw.tampil();
            dlgarw.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }
    ...
    private void MnCetakSuratSehatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehatActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("nd",Sequel.cariIsi("select nadi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            ...
            Valid.MyReportqry("rptSuratSehat.jasper","report","::[ Surat Keterangan Sehat ]::",
                ...
                " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab "+
    ...
    private void MnCetakSuratSehat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehat1ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            Valid.MyReportqry("rptSuratSehat2.jasper","report","::[ Surat Keterangan Sehat ]::",
                "select reg_periksa.no_rawat,dokter.nm_dokter,pasien.tgl_lahir,pasien.jk,"+
                " pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,',',kelurahan.nm_kel,',',kecamatan.nm_kec,',',kabupaten.nm_kab) as alamat "+
                " from reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten "+
                " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab "+
    ...
    private void MnCetakBebasNarkobaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakBebasNarkobaActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            param.put("logopemda",Sequel.cariGambar("select logopemda from gambar"));
            Valid.MyReportqry("rptSuratNarkoba.jasper","report","::[ Surat Keterangan Bebas Narkoba ]::",
                "select reg_periksa.no_rawat,dokter.nm_dokter,pasien.tgl_lahir,pasien.jk,"+
                " pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,',',kelurahan.nm_kel,',',kecamatan.nm_kec,',',kabupaten.nm_kab) as alamat "+
                " from reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten "+
                " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab "+
        ...
        if(tabModekasir.getRowCount()==0){
            ...
            if(caripenjab.equals("")&&CrPoli.getText().trim().equals("")&&CrPtg.getText().trim().equals("")&&cmbStatus.getSelectedItem().toString().equals("Semua")&&cmbStatusBayar.getSelectedItem().toString().equals("Semua")&&TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptKasirRalan.jasper","report","::[ Data Registrasi Periksa ]::",
                    ...
                    "reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by "+order,param);
            }else{
                Valid.MyReportqry("rptKasirRalan.jasper","report","::[ Data Registrasi Periksa ]::",
                    "select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                    "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
    ...
    private void MnAlihRawatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAlihRawatActionPerformed
        if(TNoRw.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"No.Rawat");
        }else{
            if(Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",TNoRw.getText())>0){
                ...
                Valid.editTable(tabModekasir,"reg_periksa","no_rawat",TNoRw,"stts='AlihRawat'");
                MnAlihrawatActionPerformed(evt);
                if(tabModekasir.getRowCount()!=0){tampilkasir();}
            }
            
        }
    }//GEN-LAST:event_MnAlihRawatActionPerformed
    ...
    private void MnCetakSuratSehat3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehat3ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            param.put("logopemda",Sequel.cariGambar("select logopemda from gambar"));
            Valid.MyReportqry("rptSuratSehatRohani.jasper","report","::[ Surat Keterangan Sehat Rohani]::",
                "select reg_periksa.no_rawat,dokter.nm_dokter,pasien.tgl_lahir,pasien.jk,"+
                " pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,',',kelurahan.nm_kel,',',kecamatan.nm_kec,',',kabupaten.nm_kab) as alamat "+
                " from reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten "+
                " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab "+
    ...
    private void MnDialihRawatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDialihRawatActionPerformed
       if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnDialihRawatActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnAlihRawat;
    ...
    private javax.swing.JMenuItem MnDialihRawat;
        ...
        try{   
            if(caripenjab.equals("")&&CrPoli.getText().trim().equals("")&&CrPtg.getText().trim().equals("")&&cmbStatus.getSelectedItem().toString().equals("Semua")&&cmbStatusBayar.getSelectedItem().toString().equals("Semua")&&TCari.getText().trim().equals("")){
                pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                    ...
                    "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where  "+
                    "reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between ? and ? order by "+order);
            }else{
                pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                    "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                    "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, "+
        ...
        try{   
            if(caripenjab.equals("")&&CrPoli.getText().trim().equals("")&&CrPtg.getText().trim().equals("")&&cmbStatus.getSelectedItem().toString().equals("Semua")&&TCari.getText().trim().equals("")){
                pskasir=koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                    ...
                    "where reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between ? and ? order by "+order);
            }else{
                pskasir=koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                    "rujukan_internal_poli.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                    "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.stts,penjab.png_jawab,rujukan_internal_poli.kd_poli,"+
