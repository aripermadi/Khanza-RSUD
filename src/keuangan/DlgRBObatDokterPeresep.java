...
public class DlgRBObatDokterPeresep extends javax.swing.JDialog {
    ...
    private double subtotal=0,ttlbiaya=0,embalase=0,ttlembalase=0,tuslah=0,ttltuslah=0,subbttlobt=0,ttlobt=0,ktg=0;
    ...
    public DlgRBObatDokterPeresep(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Dokter","Tanggal","Nama Obat","Kategori Obat","Jml","Biaya Obat","Embalase","Tuslah"};
        ...
        try {
             ...
             psresep=koneksi.prepareStatement(
                     ...
                     "resep_obat.no_rawat,pasien.nm_pasien,resep_obat.kd_dokter,databarang.nama_brng,kategori_barang.nama,"+
                     ...
                     "detail_pemberian_obat inner join databarang inner join kategori_barang "+
                     "on detail_pemberian_obat.kode_brng=databarang.kode_brng and detail_pemberian_obat.no_rawat=resep_obat.no_rawat "+
                     "and resep_obat.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and databarang.kode_kategori=kategori_barang.kode "+
                     "where detail_pemberian_obat.tgl_perawatan=resep_obat.tgl_perawatan and detail_pemberian_obat.jam=resep_obat.jam "+
                     "and resep_obat.kd_dokter=? and resep_obat.tgl_perawatan between ? and ? and reg_periksa.kd_pj like ? and detail_pemberian_obat.kode_brng like ? and databarang.nama_brng like ? order by resep_obat.tgl_perawatan");
             psresep2=koneksi.prepareStatement(
                     ...
                     "and resep_obat.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and databarang.kode_kategori=kategori_barang.kode "+
                     "where detail_pemberian_obat.tgl_perawatan=resep_obat.tgl_perawatan and detail_pemberian_obat.jam=resep_obat.jam "+
                     "and resep_obat.kd_dokter=? and resep_obat.tgl_perawatan between ? and ? and reg_periksa.kd_pj like ? and detail_pemberian_obat.kode_brng like ? and databarang.nama_brng like ? order by resep_obat.no_rawat");
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Penggunaan Obat Per Dokter Peresep ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    private void prosesCari() {             
        try{   
           ...
           while(rsdokter.next()){
               ...
               psresep.setString(5,"%"+kdbarang.getText()+"%");
               ...
               while(rsresep.next()){
                   subbttlobt=subbttlobt+rsresep.getDouble("jml");
                   ttlobt=ttlobt+rsresep.getDouble("jml");
                   ...
                   tabMode.addRow(new Object[]{
                       ...
                       rsresep.getString("tgl_perawatan")+" "+rsresep.getString("jam"),rsresep.getString("kode_brng")+" "+rsresep.getString("nama_brng"),rsresep.getString("nama"),
                       rsresep.getDouble("jml"),rsresep.getDouble("total"),rsresep.getDouble("embalase"),rsresep.getDouble("tuslah")
                   });
                   a++;
               }
               if(subtotal>0){
                   tabMode.addRow(new Object[]{"","       "+"Subtotal ",":","","",subbttlobt,subtotal,embalase,tuslah});
               }  
               i++;
           }
           tabMode.addRow(new Object[]{">>","Total ",":","","",ttlobt,ttlbiaya,ttlembalase,ttltuslah});
           this.setCursor(Cursor.getDefaultCursor());
    ...
    private void prosesCari2() {             
        try{   
           ...
           while(rsdokter.next()){
               ...
               psresep2.setString(5,"%"+kdbarang.getText()+"%");
               psresep2.setString(6,"%"+TCari.getText().trim()+"%");
               a=1;
