...
public final class DlgDetailTindakan extends javax.swing.JDialog {
    ...
    public DlgDetailTindakan(java.awt.Frame parent, boolean modal) {
        ...
        tabModeRanapDokter=new DefaultTableModel(null,new Object[]{
            "No.","No.Rawat","No.R.M.","Nama Pasien","Ktg.Tnd","Perawatan/Tindakan","Kode Dokter",
            "Dokter Yg Menangani","Tanggal","Jam","Cara Bayar","Ruangan",
            "Jasa Sarana","Paket BHP","JM Dokter","KSO","Menejemen","Total"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
             Class[] types = new Class[] {
        ...
        tabModeRanapParamedis=new DefaultTableModel(null,new Object[]{
            "No.","No.Rawat","No.R.M.","Nama Pasien","Ktg.Tindakan","Perawatan/Tindakan","NIP",
            "Paramedis Yg Menangani","Tanggal","Jam","Cara Bayar","Ruangan",
            "Jasa Sarana","Paket BHP","JM Paramedis","KSO","Menejemen","Total"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
             Class[] types = new Class[] {
        ...
        tabModeRanapDokterParamedis=new DefaultTableModel(null,new Object[]{
            "No.","No.Rawat","No.R.M.","Nama Pasien","Ktg.Tindakan","Perawatan/Tindakan","Kode Dokter",
            "Dokter Yg Menangani","NIP","Paramedis Yg Menangani","Tanggal","Jam","Cara Bayar","Ruangan",
            "Jasa Sarana","Paket BHP","JM Dokter","JM Paramedis","KSO","Menejemen","Total"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
             Class[] types = new Class[] {
        ...
        tabModeRadiologi=new DefaultTableModel(null,new Object[]{
            ...
            "Dokter P.J.Rad","NIP","Petugas Rad","Kode Perujuk","Dokter Perujuk","Tgl Periksa","Tanggal","Jam","Cara Bayar","Ruangan",
                    ...
                    if(KdDokterRanapDokter.getText().equals("")&&NmDokterRanapDokter.getText().equals("")&&KdCaraBayarRanapDokter.getText().equals("")&&NmCaraBayarRanapDokter.getText().equals("")&&TCari.getText().equals("")&&cmbStatus.getSelectedItem().equals("Semua")){
                        ...
                        if(cmbStatus.getSelectedItem().equals("Semua")){
                            Valid.MyReportqry("rptDetailTindakanRanapDokter.jasper","report","::[ Detail Tindakan Ranap Yang Ditangani Dokter ]::",
                                   "select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,"+
                                   "pasien.nm_pasien,rawat_inap_dr.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,"+
                                   "rawat_inap_dr.kd_dokter,dokter.nm_dokter,kamar_inap.tgl_keluar,"+
                                   "rawat_inap_dr.jam_rawat,penjab.png_jawab,"+
                                   "ifnull((select bangsal.nm_bangsal from kamar_inap "+
                                   "inner join kamar inner join bangsal on "+
                                   "kamar_inap.kd_kamar=kamar.kd_kamar "+
                                   ...
                                   "inner join dokter on rawat_inap_dr.kd_dokter=dokter.kd_dokter "+
                                   "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                                   "inner join kamar_inap on rawat_inap_dr.no_rawat=kamar_inap.no_rawat"+
                                   ...
                                   "kamar_inap.tgl_keluar between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like '%"+KdDokterRanapDokter.getText()+NmDokterRanapDokter.getText()+"%' and concat(reg_periksa.kd_pj,penjab.png_jawab) like '%"+KdCaraBayarRanapDokter.getText()+NmCaraBayarRanapDokter.getText()+"%' and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
    ...
    public void tampil4(){     
        ...
        try{
            if(KdOperatorOperasi.getText().equals("")&&NmOperatorOperasi.getText().equals("")&&KdAsistenOperasi.getText().equals("")&&NmAsistenOperasi.getText().equals("")&&KdCaraBayarOperasi.getText().equals("")&&NmCaraBayarOperasi.getText().equals("")&&TCari.getText().equals("")&&cmbStatus.getSelectedItem().equals("Semua")){
                ps=koneksi.prepareStatement(
                       "select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                       "operasi.kode_paket,paket_operasi.nm_perawatan,operasi.tgl_operasi,if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg, "+
                       "penjab.png_jawab,if(operasi.status='Ralan',(select nm_poli from poliklinik where poliklinik.kd_poli=reg_periksa.kd_poli),"+
                       "(select bangsal.nm_bangsal from kamar_inap inner join kamar inner join bangsal on kamar_inap.kd_kamar=kamar.kd_kamar "+
                       "and kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as ruangan,"+
                       "operator1.nm_dokter as operator1,operasi.biayaoperator1, "+
                       ...
                       "inner join petugas as instrumen on instrumen.nip=operasi.instrumen "+
                       "inner join petugas as perawaat_resusitas on perawaat_resusitas.nip=operasi.perawaat_resusitas "+
                       "where (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? order by operasi.no_rawat asc");
            }else{
                if(cmbStatus.getSelectedItem().equals("Semua")){
                    ps=koneksi.prepareStatement(
                           "select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg, "+
                           ...
                           "inner join petugas as perawaat_resusitas on perawaat_resusitas.nip=operasi.perawaat_resusitas "+
                           "where (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.no_rawat like ? or "+
                           "(select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "(select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "(select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg,                       "+
                           ...
                           "inner join petugas as perawaat_resusitas on perawaat_resusitas.nip=operasi.perawaat_resusitas "+
                           "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and o(select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.kode_paket like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and paket_operasi.nm_perawatan like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter_anestesi.nm_dokter like ? "+
                    ...
                    ps=koneksi.prepareStatement(
                           ...
                           "inner join petugas as instrumen on instrumen.nip=operasi.instrumen "+
                           "inner join petugas as perawaat_resusitas on perawaat_resusitas.nip=operasi.perawaat_resusitas "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=operasi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(operasi.operator1,operator1.nm_dokter) like ? and concat(operasi.asisten_operator1,asisten_operator1.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(operasi.status='Ralan',(select tgl_registrasi from reg_periksa where operasi.no_rawat=reg_periksa.no_rawat),\n" +
            ...
            try {
                ...
                while(rs.next()){  
                    ...
                    tabModeOperasi.addRow(new Object[]{
                        ...
                        rs.getString("nm_perawatan"),rs.getString("tglplg").substring(0,10),
    ...
    public void tampil5(){     
        ...
        try{
            if(KdDokterRanapDokter.getText().equals("")&&NmDokterRanapDokter.getText().equals("")&&KdCaraBayarRanapDokter.getText().equals("")&&NmCaraBayarRanapDokter.getText().equals("")&&TCari.getText().equals("")&&cmbStatus.getSelectedItem().equals("Semua")){
                ps=koneksi.prepareStatement(
                       "select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,"+
                       "pasien.nm_pasien,kategori_perawatan.nm_kategori,jns_perawatan_inap.nm_perawatan,"+
                       "rawat_inap_dr.kd_dokter,dokter.nm_dokter,kamar_inap.tgl_keluar,"+
                       "rawat_inap_dr.jam_rawat,penjab.png_jawab,"+
                       "ifnull((select bangsal.nm_bangsal from kamar_inap "+
                       "inner join kamar inner join bangsal on "+
                       ...
                       "where kamar_inap.tgl_keluar between ? and ? order by kamar_inap.tgl_keluar asc");
            }else{
                if(cmbStatus.getSelectedItem().equals("Semua")){
                    ps=koneksi.prepareStatement(
                           "select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,"+
                           ...
                           "inner join dokter on rawat_inap_dr.kd_dokter=dokter.kd_dokter "+
                           "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                           "inner join kamar_inap on kamar_inap.no_rawat=rawat_inap_dr.no_rawat "+
                           "inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori "+
                           "where kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.no_rawat like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan_inap.nm_perawatan like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.kd_dokter like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter.nm_dokter like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? "+
                    ...
                    ps=koneksi.prepareStatement(
                           ...
                           "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                           "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                           "inner join kamar_inap.no_rawat=rawat_inap_dr.no_rawat "+
                           "inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan_inap.nm_perawatan like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.kd_dokter like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter.nm_dokter like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? "+
                           " order by rawat_inap_dr.no_rawat desc");
                }else if(cmbStatus.getSelectedItem().equals("Sudah Lunas")){
                    ps=koneksi.prepareStatement(
                           "select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,"+
                           ...
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_dr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
        ...
        try{
            if(KdPetugasRanapParamedis.getText().equals("")&&NmPetugasRanapParamedis.getText().equals("")&&KdCaraBayarRanapParamedis.getText().equals("")&&NmCaraBayarRanapParamedis.getText().equals("")&&TCari.getText().equals("")&&cmbStatus.getSelectedItem().equals("Semua")){
                ps=koneksi.prepareStatement(
                       "select rawat_inap_pr.no_rawat,reg_periksa.no_rkm_medis,"+
                       "pasien.nm_pasien,kategori_perawatan.nm_kategori,jns_perawatan_inap.nm_perawatan,"+
                       "rawat_inap_pr.nip,petugas.nama,kamar_inap.tgl_keluar,"+
                       "rawat_inap_pr.jam_rawat,penjab.png_jawab,"+
                       "ifnull((select bangsal.nm_bangsal from kamar_inap "+
                       "inner join kamar inner join bangsal on "+
                       "kamar_inap.kd_kamar=kamar.kd_kamar "+
                       ...
                       "inner join petugas on rawat_inap_pr.nip=petugas.nip "+
                       "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                       "inner join kamar_inap on kamar_inap.no_rawat=rawat_inap_pr.no_rawat "+
                       "inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori "+ 
                       "where kamar_inap.tgl_keluar between ? and ? order by kamar_inap.tgl_keluar asc");
            }else{
                if(cmbStatus.getSelectedItem().equals("Semua")){
                    ps=koneksi.prepareStatement(
                           ...
                           "inner join kamar_inap on kamar_inap.no_rawat=rawat_inap_pr.no_rawat "+
                           "inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori "+ 
                           "where kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_pr.no_rawat like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan_inap.nm_perawatan like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_pr.nip like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and petugas.nama like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? "+
                           " order by kamar_inap.tgl_keluar asc");
                }else if(cmbStatus.getSelectedItem().equals("Belum Lunas")){
                    ps=koneksi.prepareStatement(
                           "select rawat_inap_pr.no_rawat,reg_periksa.no_rkm_medis,"+
                           "pasien.nm_pasien,kategori_perawatan.nm_kategori,jns_perawatan_inap.nm_perawatan,"+
                    ...
                    ps=koneksi.prepareStatement(
                           ...
                           "inner join kamar_inap on kamar_inap.no_rawat=rawat_inap_pr.no_rawat "+
                           "inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori "+ 
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_pr.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan_inap.nm_perawatan like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_pr.nip like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and petugas.nama like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_pr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? "+
                           " order by kamar_inap.tgl_keluar asc");
                }   
            }
        ...
        try{
            if(KdDokterRanapDokterParamedis.getText().equals("")&&NmDokterRanapDokterParamedis.getText().equals("")&&KdPetugasRanapDokterParamedis.getText().equals("")&&NmPetugasRanapDokterParamedis.getText().equals("")&&KdCaraBayarRanapDokterParamedis.getText().equals("")&&NmCaraBayarRanapDokterParamedis.getText().equals("")&&TCari.getText().equals("")&&cmbStatus.getSelectedItem().equals("Semua")){
                ps=koneksi.prepareStatement(
                       "select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis,"+
                       "pasien.nm_pasien,kategori_perawatan.nm_kategori,jns_perawatan_inap.nm_perawatan,"+
                       "rawat_inap_drpr.kd_dokter,dokter.nm_dokter,rawat_inap_drpr.nip,petugas.nama,kamar_inap.tgl_keluar,"+
                       "rawat_inap_drpr.jam_rawat,penjab.png_jawab,ifnull((select bangsal.nm_bangsal from kamar_inap "+
                       "inner join kamar inner join bangsal on kamar_inap.kd_kamar=kamar.kd_kamar "+
                       ...
                       "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                       "inner join petugas on rawat_inap_drpr.nip=petugas.nip  "+
                       "inner join kamar_inap on kamar_inap.no_rawat=rawat_inap_drpr.no_rawat "+
                       "inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori "+ 
                       "where kamar_inap.tgl_keluar between ? and ? order by kamar_inap.tgl_keluar asc");
            }else{
                if(cmbStatus.getSelectedItem().equals("Semua")){
                    ps=koneksi.prepareStatement(
                           ...
                           "inner join kamar_inap on kamar_inap.no_rawat=rawat_inap_drpr.no_rawat "+
                           "inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori "+ 
                           "where kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.no_rawat like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan_inap.nm_perawatan like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.kd_dokter like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter.nm_dokter like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.nip like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and petugas.nama like ? or "+
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ?  "+
                           " order by kamar_inap.tgl_keluar asc");
                }else if(cmbStatus.getSelectedItem().equals("Belum Lunas")){
                    ps=koneksi.prepareStatement(
                           "select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis,"+
                           ...
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan_inap.nm_perawatan like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.kd_dokter like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter.nm_dokter like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.nip like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and petugas.nama like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ?  "+
                           " order by kamar_inap.tgl_keluar asc");
                }else if(cmbStatus.getSelectedItem().equals("Sudah Lunas")){
                    ps=koneksi.prepareStatement(
                           "select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis,"+
        ...
        try{
            if(KdDokterPerujukRad.getText().equals("")&&NmDokterPerujukRad.getText().equals("")&&KdPetugasRad.getText().equals("")&&NmPetugasRad.getText().equals("")&&KdCaraBayarRad.getText().equals("")&&NmCaraBayarRad.getText().equals("")&&TCari.getText().equals("")&&cmbStatus.getSelectedItem().equals("Semua")){
                ps=koneksi.prepareStatement(
                       ...
                       "(select bangsal.nm_bangsal from kamar_inap inner join kamar inner join bangsal on kamar_inap.kd_kamar=kamar.kd_kamar "+
                       "and kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as ruangan, "+
                       "if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),"+
                       "(select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg "+
                       "from periksa_radiologi inner join reg_periksa on periksa_radiologi.no_rawat=reg_periksa.no_rawat "+
                       "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                       "inner join dokter on periksa_radiologi.kd_dokter=dokter.kd_dokter "+
                       "inner join dokter as perujuk on periksa_radiologi.dokter_perujuk=perujuk.kd_dokter "+
                       ...
                       "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                       "inner join jns_perawatan_radiologi on periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                       "where (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? order by tglplg");
            }else{
                if(cmbStatus.getSelectedItem().equals("Semua")){
                    ps=koneksi.prepareStatement(
                           "select periksa_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                       ...
                       "(select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg "+
                           ...
                           "inner join jns_perawatan_radiologi on periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                           "where (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and periksa_radiologi.no_rawat like ? or "+
                           "(select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "(select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "(select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? "+
                    ...
                    ps=koneksi.prepareStatement(
                       ...
                       "(select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg "+
                           ...
                           "inner join jns_perawatan_radiologi on periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                           "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and periksa_radiologi.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and periksa_radiologi.dokter_perujuk like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and perujuk.nm_dokter like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and p(select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? "+
                           " order by periksa_radiologi.tgl_periksa");
                }else if(cmbStatus.getSelectedItem().equals("Sudah Lunas")){
                    ps=koneksi.prepareStatement(
                       ...
                       "(select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg "+
                           ...
                           "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                           "inner join jns_perawatan_radiologi on periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and periksa_radiologi.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_radiologi.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_radiologi.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_radiologi.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_radiologi.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_radiologi.no_rawat=reg_periksa.no_rawat),\n" +
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabModeRadiologi.addRow(new Object[]{
                        ...
                        rs.getString("dokter_perujuk"),rs.getString("perujuk"),rs.getString("tgl_periksa"),
                        rs.getString("tglplg"),rs.getString("jam"),
        ...
        try{
            if(KdDokterPerujukLab.getText().equals("")&&NmDokterPerujukLab.getText().equals("")&&KdPetugasLab.getText().equals("")&&NmPetugasLab.getText().equals("")&&KdCaraBayarLab.getText().equals("")&&NmCaraBayarLab.getText().equals("")&&TCari.getText().equals("")&&cmbStatus.getSelectedItem().equals("Semua")){
                ps=koneksi.prepareStatement(
                       ...
                       "periksa_lab.kd_dokter,dokter.nm_dokter,periksa_lab.nip,"+
                       "petugas.nama,periksa_lab.dokter_perujuk,perujuk.nm_dokter as perujuk,"+
                       "periksa_lab.tgl_periksa, if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg,"
                               + "periksa_lab.jam,penjab.png_jawab,"+
                       "periksa_lab.bagian_rs,periksa_lab.bhp,periksa_lab.tarif_perujuk,"+
                       "periksa_lab.tarif_tindakan_dokter,periksa_lab.tarif_tindakan_petugas,"+
                       "periksa_lab.kso,periksa_lab.menejemen,periksa_lab.biaya,"+
                       "if(periksa_lab.status='Ralan',(select nm_poli from poliklinik where poliklinik.kd_poli=reg_periksa.kd_poli),"+
                       ...
                       "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                       "inner join jns_perawatan_lab on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                       "where (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? order by (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg)");
            }else{
                if(cmbStatus.getSelectedItem().equals("Semua")){
                    ps=koneksi.prepareStatement(
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg,"
                           ...
                           "inner join jns_perawatan_lab on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                           "where (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and periksa_lab.no_rawat like ? or "+
                           "(select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "(select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "(select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and perujuk.nm_dokter like ? or "+
                           "(select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? order by (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg)");
                }else if(cmbStatus.getSelectedItem().equals("Belum Lunas")){
                    ps=koneksi.prepareStatement(
                           "select periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg,"
                           ...
                           "inner join jns_perawatan_lab on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                           "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and periksa_lab.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
...
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg)");
                    ...
                    ps=koneksi.prepareStatement(
                           ...
                           "petugas.nama,periksa_lab.dokter_perujuk,perujuk.nm_dokter as perujuk,"+
                           "periksa_lab.tgl_periksa, if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg,periksa_lab.jam,penjab.png_jawab,"+
                           "periksa_lab.bagian_rs,periksa_lab.bhp,periksa_lab.tarif_perujuk,"+
                           "periksa_lab.tarif_tindakan_dokter,periksa_lab.tarif_tindakan_petugas,"+
                           "periksa_lab.kso,periksa_lab.menejemen,periksa_lab.biaya,"+
                           "if(periksa_lab.status='Ralan',(select nm_poli from poliklinik where poliklinik.kd_poli=reg_periksa.kd_poli),"+
                           ...
                           "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                           "inner join jns_perawatan_lab on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and periksa_lab.no_rawat like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
"                       (select kamar_inap.tgl_keluar from kamar_inap where kamar_inap.no_rawat=periksa_lab.no_rawat limit 1 )) as tglplg) between ? and ? and concat(periksa_lab.dokter_perujuk,perujuk.nm_dokter) like ? and concat(periksa_lab.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and (select if(periksa_lab.status='Ralan',(select tgl_registrasi from reg_periksa where periksa_lab.no_rawat=reg_periksa.no_rawat),\n" +
