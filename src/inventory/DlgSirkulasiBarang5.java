...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            for(int i=0;i<row;i++){  
                Sequel.menyimpan("temporary","'0',?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",36,new String[]{
            ...
            if(lokasi.equals("")){
                Valid.MyReport("rptSirkulasi9.jasper","report","::[ Sirkulasi Barang ]::",param);
            }else if(!lokasi.equals("")){
                param.put("bangsal",lokasi); 
                Valid.MyReport("rptSirkulasi10.jasper","report","::[ Sirkulasi Barang ]::",param);
            }    
