        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#fafff5' align='center' rowspan='2' width='200px'>Pabrikan</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' rowspan='2' width='200px'>Jenis</td>"+
            ...
            htmlContent.append(                             
                "<tr class='isi'>");
            kolom=0;
            ps=koneksi.prepareStatement("select kd_bangsal,nm_bangsal from bangsal where status='1' and kd_bangsal like \"UPP%\" or kd_bangsal like \"ZAPTG%\" ");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
            ...
            ps= koneksi.prepareStatement(
                    "select databarang.kode_brng,databarang.nama_brng,databarang.kode_sat,databarang.h_beli,jenis.nama,industrifarmasi.nama_industri from databarang inner join industrifarmasi inner join jenis on databarang.kode_industri=industrifarmasi.kode_industri and databarang.kdjns=jenis.kdjns where databarang.status='1' and "+
                    "jenis.nama like ? or industrifarmasi.nama_industri like ? or databarang.kode_brng like ? or databarang.nama_brng like ? order by databarang.nama_brng");
            try {
                ...
                while(rs.next()){
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='left'>"+rs.getString("nama_industri")+"</td>"+
