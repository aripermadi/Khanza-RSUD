...
public class DlgSirkulasiBarang3 extends javax.swing.JDialog {
    ...
    public DlgSirkulasiBarang3(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Barang","Nama Barang","Satuan","Hibah","Hibah(Rp)","Pembelian Langsung","Pembelian Langsung(Rp)",
                      "Pemesanan","Pemesanan(Rp)","Mutasi Masuk","Mutasi Masuk(Rp)","Mutasi Keluar","Mutasi Keluar(Rp)","Stok","Stok(Rp)"};
        ...
        for (int i = 0; i < 13; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(130);//pembelian langsung Rp.
            }else if(i==7){
                column.setPreferredWidth(70);
            }else if(i==8){
                column.setPreferredWidth(100);//penerimaan Rp.
            }else if(i==9){
                column.setPreferredWidth(80);
            }else if(i==10){
                column.setPreferredWidth(110);//Mutasi Masuk Rp.
            }else if(i==11){
                column.setPreferredWidth(80);
            }else if(i==12){
                column.setPreferredWidth(110);//Mutasi ibah Rp.
            }
        }
    ...
    private void prosesCari() {
       ...
       try{   
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if((aset>0)||(jumlahbeli>0)||(jumlahpesan>0)||(jumlahjual>0)||(jumlahpasin>0)||(jumlahpiutang>0)||
                        ...
                        tabMode.addRow(new Object[]{rs.getString(1),rs.getString(2),
                           rs.getString(3),Valid.SetAngka(jumlahhibah),Valid.SetAngka(totalhibah),
                ...
                tabMode.addRow(new Object[]{"<>>","Total :","","",Valid.SetAngka(ttltotalhibah),"",
                   Valid.SetAngka(ttltotalbeli),"",Valid.SetAngka(ttltotalpesan),"",
                   Valid.SetAngka(ttltotalmutasimasuk),"",Valid.SetAngka(ttltotalmutasikeluar),"",Valid.SetAngka(ttlaset)
                }); 
            } catch (Exception e) {
