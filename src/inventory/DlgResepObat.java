...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppResepObat.setText("Cetak Aturan Pakai Putih");
        ...
        ppResepObat1.setText("Cetak Aturan Pakai Biru");
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep.jasper","report","::[ Aturan Pakai Obat ]::",
                    ...
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y')as tgl_lahir,databarang.nama_brng,databarang.kdjns,"+
                    ...
                    "where resep_obat.no_resep='"+NoResep.getText()+"' and aturan_pakai.aturan<>'' and databarang.kdjns<>'LUAR' and databarang.kdjns<>'J008'",param);
            }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep.jasper","report","::[ Aturan Pakai Obat ]::",
                    ...
                    "and resep_obat.tgl_perawatan=detail_pemberian_obat.tgl_perawatan and " +
                    "resep_obat.jam=detail_pemberian_obat.jam and kodesatuan.kode_sat=databarang.kode_sat "+
                    "where resep_obat.no_resep='"+NoResep.getText()+"' and aturan_pakai.aturan<>'' and (databarang.kdjns='LUAR' or databarang.kdjns='J008')",param);
            }
