...
public final class DlgKunjunganRanap extends javax.swing.JDialog {
    ...
    private String setbaru="",setlama="",umurlk="",umurpr="",kddiagnosa="",kddiagnosa2="",diagnosa="",dxsekunder="",dxkomorbid="",diagnosakomorbid="";
    ...
    public DlgKunjunganRanap(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","ICD X Utama","Diagnosa Utama","ICD X Tambahan","Diagnosa Tambahan","ICD X Komorbid","Diagnosa Komorbid","Ruang","Stts.Pulang","Tgl.Masuk","DPJP"}){
        ...
        tabMode2=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","ICD X Utama","Diagnosa Utama","ICD X Tambahan","Diagnosa Tambahan","ICD X Komorbid","Diagnosa Komorbid","Ruang","Stts.Pulang","Tgl.Masuk","DPJP"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dpjp_ranap inner join dokter inner join penjab " +
                    ...
                    "and reg_periksa.kd_pj=penjab.kd_pj and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.no_rawat=dpjp_ranap.no_rawat "+
                    "and dpjp_ranap.kd_dokter=dokter.kd_dokter and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel where "+                  
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                            ...
                            "where diagnosa_pasien.no_rawat=? and prioritas='1' order by prioritas asc");
                    try {                                    
                        ps2.setString(1,rs.getString("no_rawat"));
                        rs2=ps2.executeQuery();
                        while(rs2.next()){
                        if(kddiagnosa.equals("")){
...
//                        
                    ...
                    try {                                    
                        ...
                        while(rs5.next()){
                        if(kddiagnosa2.equals("")){
                                        kddiagnosa2=rs5.getString(1);
                                        dxsekunder=rs5.getString(2);
                                    }else{
                                        kddiagnosa2=kddiagnosa2+", "+rs5.getString(1);
                                        dxsekunder=dxsekunder+", "+rs5.getString(2);
                                    }
                                }
                    ...
                    ps4=koneksi.prepareStatement(
                            "select penyakit.kd_penyakit,penyakit.nm_penyakit from penyakit inner join diagnosa_pasien " +
                            "on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit " +
                            "where diagnosa_pasien.no_rawat=? and status_penyakit='Lama' order by prioritas");
                    try {                                    
                        ps4.setString(1,rs.getString("no_rawat"));
                        rs4=ps4.executeQuery();
                        while(rs4.next()){
                        if(dxkomorbid.equals("")){
                                        dxkomorbid=rs4.getString(1);
                                        diagnosakomorbid=rs4.getString(2);
                                    }else{
                                        dxkomorbid=dxkomorbid+", "+rs4.getString(1);
                                        diagnosakomorbid=diagnosakomorbid+", "+rs4.getString(2);
                                    }
                                }
//                        
                    } catch (Exception e) {
                    ...
                    tabMode.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiagnosa,diagnosa,
                        kddiagnosa2,dxsekunder,dxkomorbid,diagnosakomorbid,
                        rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("stts_pulang"),rs.getString("tgl_masuk"),rs.getString("nm_dokter")
                    });                
                    i++;
                }
                if(i>=2){
    ...
    public void tampil2(){        
        try{   
            ...
            ps3=koneksi.prepareStatement(
                    ...
                    "kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.no_rawat=dpjp_ranap.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and pasien.kd_kab=kabupaten.kd_kab "+
                    "and dpjp_ranap.kd_dokter=dokter.kd_dokter and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel where "+
...
//                        
                    ...
                    tabMode2.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiagnosa,diagnosa,
                        kddiagnosa2,dxsekunder,dxkomorbid,diagnosakomorbid,
                        rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("stts_pulang"),rs.getString("tgl_keluar"),rs.getString("nm_dokter")
                    });                
                    i++;
                }
                if(i>=2){
